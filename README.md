...
- [🌬️ Air Quality Smart Window](#️-air-quality-smart-window)
    - [ESP32-Based Automated Sliding Window for Ambient Air Quality Monitoring](#esp32-based-automated-sliding-window-for-ambient-air-quality-monitoring)
  - [📖 Table of Contents](#-table-of-contents)
  - [🧭 Project Overview](#-project-overview)
    - [Problem Statement](#problem-statement)
    - [Why Indoor Air Quality Matters](#why-indoor-air-quality-matters)
    - [Why Window Automation](#why-window-automation)
  ...
  - [👥 Contributors](#-contributors)
    - [⭐ If you found this project interesting, consider starring the repository!](#-if-you-found-this-project-interesting-consider-starring-the-repository)
